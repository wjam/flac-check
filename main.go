...
func root() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(
		...
		"artists which are expected to have lyrics with non-asccii characters",
	)
	cmd.Flags().Uint16Var(
	...
	for _, s := range []string{coverartBaseUrl, lrclibBaseUrl, musicbrainzBaseUrl, lrclibBaseUrl, musicbrainzBaseUrl} {
